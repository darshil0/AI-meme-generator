...
- **AI Model Stability**: Upgraded to **Gemini 3.0 Flash Preview**, the latest frontier model, offering significantly improved visual reasoning and joke generation.
...
- **1.8.0**: Complete project organization, fixed ESM issues, upgraded Gemini model to **3.0-flash-preview**, and overhauled documentation including a new backend README.
